...
then
    ...
    pip install Django==1.6 python-memcached six django-classy-tags south django-wymeditor django-sekizai
    deactivate
fi
if [ ! -d .venv_16_p3 ]
then
    ...
    pip install Django==1.6 python3-memcached six django-classy-tags south django-wymeditor django-sekizai
    deactivate
fi

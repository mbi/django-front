...
DJANGO_FRONT_ALLOWED_EDITORS = [editor.lower() for editor in getattr(settings, 'DJANGO_FRONT_ALLOWED_EDITORS', ['ace', 'ace-local', 'wymeditor', 'redactor', 'epiceditor', 'ckeditor', 'default', 'froala'])]

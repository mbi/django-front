(function (jQuery) {
    var triggerEditor = function (el) {
        ...
        switch (front_edit_options.edit_mode) {
            ...
            case 'lightbox':
                jQuery('<div id="front-edit-lightbox-container" class="active front-edit-dialog_layer front-edit-layer"><div id="front-edit-lightbox" class="front-edit-dialog"></div></div>').appendTo(body);
